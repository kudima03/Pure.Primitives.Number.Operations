...
public sealed record GreaterThanOrEqualConditionTests
{
    ...
    {
        IBool condition = new GreaterThanOrEqualCondition<int>(
            new Int(10),
            new Int(10),
            new Int(10)
        );
    ...
    public void ThrowsExceptionOnGetHashCode()
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new GreaterThanOrEqualCondition<float>(new Float(10)).GetHashCode()
        );
    }
    ...
    {
        _ = Assert.Throws<NotSupportedException>(() =>
            new GreaterThanOrEqualCondition<float>(new Float(10)).ToString()
        );
    }
}
